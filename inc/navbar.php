<div class="menu border-bottom border-black sticky-top ">
    <nav class="navbar navbar-expand-lg shadow-lg navbar-light px-5">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse " id="navbarNav">
                <div class="menu w-100 d-flex justify-content-between align-items-center">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-dark" href="?pg=user">Manage Account</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active text-dark" href="?pg=peminjaman">Peminjaman</a>
                        </li>
                        <li class="nav-item">
